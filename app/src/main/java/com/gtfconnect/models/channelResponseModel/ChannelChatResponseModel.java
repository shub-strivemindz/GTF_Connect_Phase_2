...
public class ChannelChatResponseModel {
    ...
    public class Row {
        ...
        @Expose
        private List<CommentResponseModel> commentData;
        ...
        public List<CommentResponseModel> getCommentData() {
            return commentData;
        }

        public void setCommentData(List<CommentResponseModel> commentData) {
