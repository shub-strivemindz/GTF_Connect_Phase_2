...
public class ConnectViewModel extends AndroidViewModel {
    ...
    public void get_admin_group_channel_settings(int id,String endPoint, String api_token,String device_type, String device_token) {
        disposables.add(repo.get_admin_group_channel_settings(id, endPoint, api_token, device_type, device_token).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).doOnSubscribe(new Consumer<Disposable>() {
            @Override
            public void accept(Disposable disposable) throws Exception {
                responseLiveData.setValue(ApiResponse.loading());
            }
    ...
    public void update_groupChannel_permission_settings(int id, String endPoint, String api_token, String device_type, String device_token, Map<String,Object> params) {
        disposables.add(repo.update_group_channel_permission_settings(id, endPoint, api_token, device_type, device_token,params).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).doOnSubscribe(new Consumer<Disposable>() {
            @Override
            public void accept(Disposable disposable) throws Exception {
                responseLiveData.setValue(ApiResponse.loading());
            }
