...
public class SavedMessagesScreen extends AppCompatActivity implements ApiResponseListener {

    ActivitySavedMessageBinding binding;


    private final int GET_SAVED_MESSAGE = 101;

    private final int DELETE_SAVED_MESSAGE = 102;
    ...
    private void init() {
        ...
        requestType = GET_SAVED_MESSAGE;
        connectViewModel.get_saved_messages(PreferenceConnector.readString(this, PreferenceConnector.API_GTF_TOKEN_, ""),"android","test",20,1);
    }
    ...
    private void renderResponse(JsonObject jsonObject) {
        ...
        if (requestType == GET_SAVED_MESSAGE) {
            ...
            if (savedMessageResponseModel != null && savedMessageResponseModel.getData() != null && savedMessageResponseModel.getData().getList() != null && !savedMessageResponseModel.getData().getList().isEmpty()) {
                ...
                // load saved messages  ------
                SavedMessageAdapter savedMessageViewAdapter = new SavedMessageAdapter(SavedMessagesScreen.this, savedMessageResponseModel);
