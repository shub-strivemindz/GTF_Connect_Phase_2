...
public class ChannelPinnedMessageScreen extends AppCompatActivity implements ApiResponseListener, PinnedMessageListener {
...
// Loading pinned message data ------
        ...
        binding.pinnedMessageRecycler.setLayoutManager(new LinearLayoutManager(this));
    ...
    public void gotoMessage(String groupChatId) {
        Intent intent = new Intent(this, ChannelChatsScreen.class);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(this, ChannelChatsScreen.class));
        finish();
    }
}
