...
import com.gtfconnect.databinding.RecyclerMultipleSavedMediaItemBinding;
import com.gtfconnect.databinding.RecyclerSingleChatMediaItemBinding;
import com.gtfconnect.databinding.RecyclerSingleSavedMediaItemBinding;
...
public class SavedMessageMediaAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public  SavedMessageMediaAdapter(Context context,List<MediaListModel> mediaList,String postBaseUrl,String userID, String user_name, ExoPlayer previousPlaybackInstance,boolean isVideoAutoPlay,boolean isGifAutoPlay){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        if (viewType == 1){
            return new SingleMediaItemViewHolder(RecyclerSingleSavedMediaItemBinding.inflate(LayoutInflater.from(viewGroup.getContext()),viewGroup,false));
        }
        else{
            return new MultiMediaItemViewHolder(RecyclerMultipleSavedMediaItemBinding.inflate(LayoutInflater.from(viewGroup.getContext()),viewGroup,false));
        }
    }
    ...
    static class SingleMediaItemViewHolder extends RecyclerView.ViewHolder {
        RecyclerSingleSavedMediaItemBinding binding;

        SingleMediaItemViewHolder(@NonNull RecyclerSingleSavedMediaItemBinding binding) {
    ...
    static class MultiMediaItemViewHolder extends RecyclerView.ViewHolder {
        RecyclerMultipleSavedMediaItemBinding binding;

        MultiMediaItemViewHolder(@NonNull RecyclerMultipleSavedMediaItemBinding binding) {
            super(binding.getRoot());
            this.binding = binding;
